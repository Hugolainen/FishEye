...
request.onload = function() {
    ...
    function generateCard(index){
        ...
        photographerName.innerHTML = "<a href=\"photographPage.html\">  <img class=\"header__logo\" src=\"public/img/photographersIDphotos/" +newPhotographer.portrait + "\" alt=\"" + newPhotographer.name + "\" > <br>" + newPhotographer.name + "</a>";
